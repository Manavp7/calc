...
export default function SupportMaintenance() {
    ...
    return (
        <section className="section bg-gradient-to-b from-gray-900 to-black py-16 flex flex-col justify-center">
            ...
            `}
                    ...
                    {!inputs.ideaType && inputs.selectedFeatures.length === 0 && (
                        <p className="text-red-400 mt-4 text-sm">
                            Please select an idea type or at least one feature to continue
                        </p>
                    )}
                </motion.div>
            </div>
